...
`accuracyboost` to 3 shifts the chi2 by -0.023 (and the stress value
...
`k_per_logint` to 50 by +0.0001. The all-knobs checks (comparing the
default accuracyboost 1 against 3) stay within -0.051 to +0.014
